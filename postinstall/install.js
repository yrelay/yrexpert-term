...
var moveDirectory = function(oldPath, newPath) {
  ...
  if (fs.existsSync(oldPath)) {
    ...
    console.log('Mise en garde : ' + oldPath + ' le module yrexpert-term n\'existe plus dans le répertoire');
  }
  return error;
...
var tidyUp = function(path) {
  var postinstallPath = path + '/node_modules/yrexpert-term/postinstall';
...
var installEWD = function(path) {
  ...
  console.log('installer yrexpert-term vers ' + path);
  //if (os.type() === 'Linux') {}

  var postinstallPath = path + '/node_modules/yrexpert-term/postinstall';

  // Copier le répertoire /www dans yrexpert-term
  ...
  console.log('yrexpert-term a été installé et configuré avec succès');

};

var installExtras = function(path) {
  var installErrors = false;
  console.log('Installer des ressources supplémentaires à yrexpert-term ' + path);

  var extrasPath = path + '/node_modules/yrexpert-term/extras';
...
// Mode silencieux : Essayer de lire les options de configuration à partir du fichier nommé yrexpert-termSilent.js
...
var paramsFile = '../../yrexpert-termSilent.js';
...
if (params.silent) {
  ...
  if (params.extras) {
    ...
    var extrasPath = installPath + '/node_modules/yrexpert-term/extras';
...
interface.question('Installer yrexpert-term vers le répertoire (' + process.cwd() + '): ', function(installPath) {
  ...
  console.log("Si vous êtes nouveau sur yrexpert-term ou voulez créer un environnement de test, entrer Y");
